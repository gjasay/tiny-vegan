...
const Hero = () => {
  return (
    <div
      id="hero"
      className="flex flex-col justify-around items-center text-center h-screen bg-cover bg-center mt-20 py-8 pb-16 md:flex-row md:justify-between md:px-20"
    >
      ...
      <button className="bg-amber-200 hover:bg-green-600 text-2xl py-3 px-5 my-8 rounded-full mx-auto font-light border-black border-2 md:mx-0">
        Order Now
      </button>
